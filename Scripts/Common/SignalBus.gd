...
signal player_exited_quest_giver_area(quest: Quest)
signal quest_started(quest: Quest)
signal quest_collectable_obtained(collectable: QuestCollectable)
signal quest_progress_updated(quest: Quest)
signal quest_completed(quest: Quest)
signal quest_reward_obtained(quest: Quest)
